...
The attached screenshots show the outputs of the script when run in Azure Kinect camera and placed on a knee with a paper cutout and without a paper cutout:
